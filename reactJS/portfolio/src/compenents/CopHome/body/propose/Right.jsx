...
function Right({ title, content, source }) {
    return (
        <div className='flex flex-col md:flex-row-reverse items-center gap-8 p-8 rounded-xl bg-white shadow-lg hover:shadow-xl transition-shadow duration-300'>
