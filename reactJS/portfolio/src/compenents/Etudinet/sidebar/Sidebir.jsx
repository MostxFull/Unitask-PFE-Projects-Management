...
import SummerUser from "./summerUser";
          ...
          <nav className="space-y-4">
            ...
            <div>
              ...
              {openSections.dashboard && (
                  <div className="ml-6 space-y-2 mt-2">
                    <NavLink
                        to={`/etudiant/${id}/dashbord/Overview`}
                        className={({ isActive }) =>
                    ...
                    <NavLink
                        to={`/etudiant/${id}/dashbord/calendrie`}
                        className={({ isActive }) =>
                            `flex items-center gap-2 p-2 rounded-lg transition-colors ${
                                isActive ? 'bg-blue-100 text-blue-600' : 'hover:bg-blue-50'
                            }`
            ...
            <div>
              ...
              {openSections.workspace && (
                  <div className="ml-6 space-y-2 mt-2">
                    <NavLink
                        to={`/etudiant/${id}/wokspace/MembersInfo`}
                        className={({ isActive }) =>
                            `flex items-center gap-2 p-2 rounded-lg transition-colors ${
                    ...
                    <NavLink
                        to={`/etudiant/${id}/dashbord/EmailManagement`}
                        className={({ isActive }) =>
                            `flex items-center gap-2 p-2 rounded-lg transition-colors ${
                                isActive ? 'bg-purple-100 text-purple-600' : 'hover:bg-purple-50'
                            }`
            ...
            <div>
              ...
              {openSections.tasks && (
                  <div className="ml-6 space-y-2 mt-2">
                    <NavLink
                        to={`/etudiant/${id}/tasks/TaskProjet`}
                        className={({ isActive }) =>
                            `flex items-center gap-2 p-2 rounded-lg transition-colors ${
            ...
            <div>
              ...
              {openSections.settings && (
                  <div className="ml-6 space-y-2 mt-2">
                    {/*<NavLink*/}
                    {/*    to={`/etudiant/${id}/Settings/HelpCenter`}*/}
                    {/*    className={({ isActive }) =>*/}
                    {/*        `flex items-center gap-2 p-2 rounded-lg transition-colors ${*/}
                    ...
                    {/*</NavLink>*/}
                    <NavLink
                        to={`/etudiant/${id}/Settings/Profil`}
                        className={({ isActive }) =>
                            `flex items-center gap-2 p-2 rounded-lg transition-colors ${
                                isActive ? 'bg-red-100 text-red-600' : 'hover:bg-red-50'
                            }`
